<div class="container-fluid">
  ...
  <p class="mb-4">Data berikut merupakan kumpulan Layanan yang berlaku di <b>Dinas Lingkungan Hidup dan Kehutanan</b> - Kota Kendari</p>
  <hr>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        <label for=""><b>Gambar Layanan</b></label>
       ...
       <div class="form-group">
        <label for=""><b>Isi Layanan</b></label>
      ...
      <div class="form-group">
        <label for=""><b>Tanggal Layanan</b></label>
      ...
      <hr>
      <button style="width: 100%" class="btn btn-warning" type="submit">Edit Layanan</button>
      <?php echo form_close(); ?>
    </div>
  </div>
