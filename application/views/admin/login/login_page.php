            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <?php echo form_close(); ?>
                  <hr>
                  <center style="font-size: 12px;">Copyright @2019, <?php echo $settings_app[0]->setting_origin_app;?><br>Support By <a href="http://technos-studio.com" class="text-danger" >Techno's Studio</a></center>
                  <!-- <div class="text-center">
